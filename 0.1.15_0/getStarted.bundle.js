(() => {
  var e = {
      725: (e, t, n) => {
        ...
        f.push([
          e.id,
          `body,html{height:100%;width:100%;margin:0}body{font-family:"Inter","Google Sans",Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-style:normal;font-weight:500;padding:0}.get-started-page-container{width:100vw;height:100%;min-height:100%;box-sizing:border-box;overflow-x:hidden;overflow-y:hidden;background:url(${h}) no-repeat left top,url(${d}) no-repeat right bottom,#fff;text-align:center}.get-started-page-container .logo{width:100%;margin:8.8vh auto 3.3vh auto;text-align:center;user-select:none;display:flex;justify-content:center;align-items:flex-end}.get-started-page-container .logo img{height:48px;width:48px;margin:0}.get-started-page-container .logo span{color:#7cea57;font-weight:600;font-size:32px}.get-started-page-container .header{font-weight:600;font-size:3.6vh;line-height:3.6vh;text-align:center;color:#000;margin:0 auto 3.8vh auto;width:100%}.get-started-page-container .header img{width:3.22vh;height:3.22vh;margin:0 0 0 1.62vh;user-select:none}.get-started-page-container .description{font-weight:500;font-size:2.7vh;line-height:2.7vh;width:100%;text-align:center;color:#000;margin-bottom:6.1vh}.get-started-page-container .action{margin-bottom:6.7vh;width:100%;text-align:center;line-height:3.4vh}.get-started-page-container .action span{font-weight:500;font-size:2.25vh;color:#000}.get-started-page-container .action a{user-select:none;text-decoration:none;padding:12px 22px;background:linear-gradient(180deg, #8255e9 0%, #5c61ee 108.53%);border-radius:4px;font-weight:600;font-size:1.5vh;text-align:center;color:#fff;margin-left:3.58vh;cursor:pointer}.get-started-page-container .steps{width:100%;text-align:center;user-select:none}.get-started-page-container .steps img{width:80%;margin:0 auto}`,
          "",
        ]);
        const p = f;
      },
      ...
      744: function (e, t, n) {
        e.exports = (function () {
          ...
          function A(e) {
            return (
              ...
              (e = (function e(t) {
                ...
                } else if (O.has(t.constructor)) n = t;
                else {
                  var i,
                    u = s(t);
                  for (i in ((n =
                    ...
                    ? "string" == typeof e
                      ...
                      : "object" == typeof e &&
                        ((this.message = ""
                          ...
                          .concat(e.message)),
                        (this.inner = e))
                    : ((this.message = N[t] || n), (this.inner = null));
              }
              return p(r).from(G), (e[t] = r), e;
            }, {});
          (L.Syntax = SyntaxError),
            (L.Type = TypeError),
            (L.Range = RangeError);
          ...
          (H.ModifyError = Z), (H.DexieError = F), (H.BulkError = V);
          var oe =
          ...
          var ae = {},
            ...
            se =
              ...
              P[0]),
            ce =
              ((q = P[1]), (P = P[2]), (q = q && q.then), se && se.constructor),
            le = !!P,
            fe = function (e, t) {
              be.push([e, t]), de && (queueMicrotask(Ae), (de = !1));
            },
            he = !0,
            de = !0,
            pe = [],
          ...
          function xe(e) {
            ...
            if ("function" != typeof e) {
              ...
              return (
                ...
                void (!1 === this._state && Ie(this, this._value))
              );
            }
            (this._state = null),
              (this._value = null),
          ...
          var ke = {
            get: function () {
              ...
              function n(n, r) {
                var o = this,
                  i = !e.global && (e !== ge || t !== Ne),
                  a = i && !Ve(),
                  u = new xe(function (t, u) {
                    Oe(o, new Se(Je(n, e, i, a), Je(r, e, i, a), t, u, e));
                  });
                return (
          ...
          function Pe(e) {
            var t = e._listeners;
            e._listeners = [];
            for (var n = 0, r = t.length; n < r; ++n) Oe(e, t[n]);
            var o = e._PSD;
            --o.ref || o.finalize(),
              0 === we &&
                (++we,
          ...
          f(xe.prototype, {
            then: ke,
            _then: function (e, t) {
              Oe(this, new Se(null, null, e, t, ge));
            },
            catch: function (e) {
            ...
            "undefined" != typeof Symbol &&
              Symbol.toStringTag &&
              d(xe.prototype, Symbol.toStringTag, "Dexie.Promise"),
            (me.env = We()),
            f(xe, {
              all: function () {
                var e = R.apply(null, arguments).map(ze);
          ...
          function Ze() {
            return (
              Be.id || (Be.id = ++Re), ++Be.awaits, (Be.echoes += ue), Be.id
            );
          }
          function Ve() {
            return (
              !!Be.awaits &&
              (0 == --Be.awaits && (Be.id = 0),
              (Be.echoes = Be.awaits * ue),
              !0)
            );
          }
          function ze(e) {
            return Be.echoes && e && e.constructor === ce
              ? (Ze(),
                e.then(
                  function (e) {
                    return Ve(), e;
            ...
            (t
              ...
              queueMicrotask(
                t
                  ? function (e) {
                      ++Ne,
                        (Be.echoes && 0 != --Be.echoes) ||
                          (Be.echoes = Be.awaits = Be.id = 0),
                        Me.push(ge),
                        Le(e, !0);
                    }.bind(null, e)
                  : Ge
            ...
            return "function" != typeof e
              ...
              : function () {
                  ...
                  try {
                    ...
                    Le(o, !1), r && queueMicrotask(Ve);
                  }
                };
          }
          function Ye(e) {
            Promise === ce && 0 === Be.echoes
              ? 0 === qe
                ? e()
                : enqueueNativeMicroTask(e)
              : setTimeout(e, 0);
          }
          -1 === ("" + q).indexOf("[native code]") && (Ze = Ve = J);
          var Xe = xe.reject,
          ...
          function lt(e) {
            ...
            return "object" != t
              ? t
              : ArrayBuffer.isView(e) || "ArrayBuffer" === (e = E(e))
              ? "binary"
              : e;
          }
          function ft(e) {
          ...
          var ht =
                  ...
                  r && r.db._novip === this.db._novip
                    ...
                    : (function e(t, n, r, o) {
                        ...
                        if (t._state.openComplete)
                          return Xe(new L.DatabaseClosed(t._state.dbOpenError));
                        if (!t._state.isBeingOpened) {
                          if (!t._state.autoOpen)
                            return Xe(new L.DatabaseClosed());
                          t.open().catch(J);
                        }
            ...
            (dt.prototype.get = function (e, t) {
              ...
              return e && e.constructor === Object
                ...
                : null == e
                ? Xe(new L.Type("Invalid argument to Table.get()"))
          ...
          function Ct(e, t, n) {
            return (
              ((e = e instanceof Bt ? new e.Collection(e) : e)._ctx.error =
                new (n || TypeError)(t)),
              e
            );
          }
          ...
          var Bt =
            (Object.defineProperty(Rt.prototype, "Collection", {
              get: function () {
            ...
            (Rt.prototype.inAnyRange = function (e, t) {
              ...
              return (
                ((e = new this.Collection(this, function () {
                  ...
                  (f = "next" === e ? ((v = p), o) : ((v = y), i)), s.sort(h);
                }),
                e._addAlgorithm(function (e, t, r) {
                  for (var i, a = e.key; v(a); )
                    if (++d === s.length) return t(r), !1;
                  return (
                    (!p((i = a)) && !y(i)) ||
                    (0 === n._cmp(a, s[d][1]) ||
                      0 === n._cmp(a, s[d][0]) ||
                      t(function () {
                        f === o ? e.continue(s[d][0]) : e.continue(s[d][1]);
                      }),
                    !1)
                  );
                }),
          ...
          var Nt = "storagemutated",
            ...
            Zt =
              ...
              (Vt.prototype.create = function (e) {
                ...
                return (
                  ...
                  (e.onabort = De(function (n) {
                    qt(n),
                      t.active && t._reject(new L.Abort(e.error)),
                      (t.active = !1),
                      t.on("abort").fire(n);
                  })),
              ...
              (Vt.prototype._promise = function (e, t, n) {
                var r = this;
                if ("readwrite" === e && "readwrite" !== this.mode)
                  return Xe(new L.ReadOnly("Transaction is readonly"));
                if (!this.active) return Xe(new L.TransactionInactive());
                if (this._locked())
          ...
          function en(e, t) {
            var n = t.db;
            (t = $t(e._middlewares, n, e._deps, t)),
              (e.core = t.dbcore),
                  ...
                  : (e[n] = (function e(t) {
                      ...
                      for (n in t)
                        l(t, n) &&
                          ((r = t[n]),
                          (o[n] =
                            !r || "object" != typeof r || O.has(r.constructor)
                              ? r
                              : e(r)));
                      return o;
                    })(t[n]));
          ...
          function Bn(e) {
            ...
            function s() {
              return new xe(function (r, c) {
                ...
                var l = e.name,
                  d = t.autoSchema || !o ? n.open(l) : n.open(l, o);
                if (!d) throw new L.MissingAPI();
                (d.onerror = Mt(c)),
                  (d.onblocked = De(e._fireOnBlocked)),
                  (d.onupgradeneeded = De(function (r) {
                    var o;
                    (f = d.transaction),
                  ...
                  xe
                    ...
                    .then(function n() {
                      if (0 < t.onReadyBeingFired.length) {
                        var r = t.onReadyBeingFired.reduce(re, J);
                        return (
                          (t.onReadyBeingFired = []),
                          xe
                            .resolve(
                        ...
                        return Object.create(n, {
                          continue: {
                            value: function (r) {
                              null != r
                                ? n.continue(
                                    Mn(r, t.reverse ? e.MAX_KEY : e.MIN_KEY, o)
                                  )
                                : t.unique
                                ? n.continue(
                                    n.key
                          ...
                          continuePrimaryKey: {
                            value: function (t, r) {
                              n.continuePrimaryKey(Mn(t, e.MAX_KEY, o), r);
                            },
                          },
                          primaryKey: {
                            get: function () {
                            ...
                            var n = d.map(function (n, r) {
                              ...
                              return (
                                "delete" === e.type
                                  ? s.fire.call(p, n, d, h)
                                  : "add" === e.type || void 0 === d
                                  ? ((o = c.fire.call(p, n, e.values[r], h)),
                                    null == n &&
                                      null != o &&
                                      ((e.keys[r] = n = o),
                                      i.outbound ||
                ...
                table: function (n) {
                  ...
                  return t(t({}, r), {
                    getMany: function (e) {
                      ...
                      var t = Zn(e.keys, e.trans._cache, "clone" === e.cache);
                      return t
                        ? xe.resolve(t)
                          ...
                          s.mutate(e).then(function (t) {
                            return (
                              !g ||
                                ("add" !== e.type && "put" !== e.type) ||
                                p.addKeys(t.results),
                              (h.mutatedParts = On(h.mutatedParts || {}, d)),
                              t
                            );
                          })
                        );
          ...
          function Jn(e, t, n, r, o, i) {
            ...
            var u = t.query.index,
              ...
              f = u.extractKey,
              h = (u.lowLevelIndex || u).extractKey;
            return (
              ...
              return t(t({}, e), {
                ...
                table: function (r) {
                  ...
                  return t(t({}, o), {
                    ...
                    query: function (e) {
                      if (!zn(ge, o) || !Gn("query", e)) return o.query(e);
                      var t =
                          "immutable" ===
          ...
          var tr =
            ...
            (nr.prototype._whenReady = function (e) {
              ...
              return this.idbdb &&
                ...
                : new xe(function (e, n) {
                    if (t._state.openComplete)
                      return n(new L.DatabaseClosed(t._state.dbOpenError));
                    if (!t._state.isBeingOpened) {
                      if (!t._state.autoOpen)
                        return void n(new L.DatabaseClosed());
                      t.open().catch(J);
                    }
            ...
            (nr.prototype.close = function (e) {
              ...
              (e = this._state),
                t
                  ? (e.isBeingOpened && e.cancelOpen(new L.DatabaseClosed()),
                    this._close(),
                    (e.autoOpen = !1),
                    (e.dbOpenError = new L.DatabaseClosed()))
                  : (this._close(),
                ...
                function a() {
                  ...
                  (n.onsuccess = De(function () {
                    ...
                    (e = t._deps),
                      ...
                      (r = e.indexedDB),
                      (e = e.IDBKeyRange),
                      mn(r) || n === nt || vn(r, e).delete(n).catch(J),
                      o();
                  })),
                    (n.onerror = Mt(i)),
                ...
                return xe.resolve().then(function () {
                  ...
                  return (
                    ...
                    (a = xe.follow(function () {
                      ...
                      (s = i.call(u, u)) &&
                        (c
                          ? ((e = Ve.bind(null, null)), s.then(e, e))
          ...
          function nr(e, n) {
            ...
            (l.dbReadyPromise = new xe(function (e) {
              ...
              (this.Transaction =
                ((u = this),
                yt(Zt.prototype, function (e, t, n, r, o) {
                  var i = this;
                  (this.db = u),
                    (this.mode = e),
                    (this.storeNames = t),
              ...
              (this.WhereClause =
                ((c = this),
                yt(Bt.prototype, function (e, t, n) {
                  if (
                    ((this.db = c),
                    (this._ctx = {
                      table: e,
                  ...
                  c = {
                    ...
                    unsubscribe: function () {
                      a ||
                        ((a = !0),
                        o && o.abort(),
                        f && Ut.storagemutated.unsubscribe(d));
                    },
                  };
                r.start && r.start(c);
                var f = !1,
          ...
          f(
            ...
            t(t({}, H), {
              ...
              ignoreTransaction: function (e) {
                return ge.trans ? He(ge.transless, e) : e();
              },
              vip: gn,
              async: function (e) {
                return function () {
      ...
      156: (e) => {
        "use strict";
        e.exports =
          "data:image/svg+xml;base64,";
      },
      881: (e) => {
        "use strict";
        e.exports =
          "data:image/svg+xml;base64,";
      },
      330: (e) => {
        "use strict";
        e.exports = { rE: "0.1.15" };
    ...
    (() => {
      ...
      function _(e, t, n) {
        ...
        return (
          ...
          h && f && f.running ? ((r.tState = u), y.push(r)) : T(r),
          C.bind(r)
        );
      }
      function x(e) {
        if (!d && null === p) return e();
        const t = p;
        p = null;
        try {
          return d ? d.untrack(e) : e();
        } finally {
          p = t;
        }
      }
      function k(e) {
        return (
          null === l ||
            (null === l.cleanups ? (l.cleanups = [e]) : l.cleanups.push(e)),
          e
        );
      }
      function S(e) {
      ...
      function O(e, t) {
        ...
        return { id: n, Provider: L(n), defaultValue: e };
      }
      function j(e) {
        const t = _(e),
          n = _(() => G(t()));
      ...
      function C() {
        ...
        if (this.sources && (e ? this.tState : this.state))
          if ((e ? this.tState : this.state) === u) T(this);
          else {
            const e = y;
            (y = null), R(() => q(this), !1), (y = e);
          }
        if (p) {
          ...
          e.observers &&
            ...
            R(() => {
              for (let t = 0; t < e.observers.length; t += 1) {
                ...
                (r && f.disposed.has(n)) ||
                  ((r ? n.tState : n.state) ||
                    (n.pure ? y.push(n) : v.push(n), n.observers && N(n)),
                  r ? (n.tState = u) : (n.state = u));
              }
      ...
      function T(e) {
        ...
        F(e);
        const t = m;
        K(e, f && f.running && f.sources.has(e) ? e.tValue : e.value, t),
          f &&
            !f.running &&
            f.sources.has(e) &&
            queueMicrotask(() => {
      ...
      function D(e, t, n, r = u, o) {
        ...
        if (
          ...
          const [e, t] = b(void 0, { equals: !1 }),
            n = d.factory(i.fn, t);
          k(() => n.dispose());
          const r = () => S(t).then(() => o.dispose()),
            o = d.factory(i.fn, r);
      ...
      function B(e) {
        ...
        if ((t ? e.tState : e.state) === s) return q(e);
        ...
        for (let r = n.length - 1; r >= 0; r--) {
          ...
          if ((t ? e.tState : e.state) === u) T(e);
          else if ((t ? e.tState : e.state) === s) {
            const t = y;
            (y = null), R(() => q(e, n[0]), !1), (y = t);
          }
        }
      }
      function R(e, t) {
      ...
      function q(e, t) {
        ...
        for (let r = 0; r < e.sources.length; r += 1) {
          ...
          if (o.sources) {
            ...
            e === u
              ? o !== t && (!o.updatedAt || o.updatedAt < m) && B(o)
              : e === s && q(o, t);
          }
        }
      }
      function N(e) {
        ...
        for (let n = 0; n < e.observers.length; n += 1) {
          ...
          (t ? r.tState : r.state) ||
            (t ? (r.tState = s) : (r.state = s),
            r.pure ? y.push(r) : v.push(r),
            r.observers && N(r));
        }
      }
      function F(e) {
      ...
      function U(e, t) {
        if ((t || ((e.tState = 0), f.disposed.add(e)), e.owned))
          for (let t = 0; t < e.owned.length; t++) U(e.owned[t]);
      }
      function Z(e) {
      ...
      function z(e, t = l) {
        const n = i && t && t.context && t.context[i],
          r = Z(e);
        if (!n) throw r;
        v
          ? v.push({
      ...
      function J(e, t, n, r = {}) {
        ...
        return (
          g((r) => {
            (o = r),
              t === document ? e() : Q(t, e(), t.firstChild ? null : void 0, n);
          }, r.owner),
          () => {
            o(), (t.textContent = "");
          }
      ...
      function ee(e, t, n, r) {
        ...
        for (let i = 0, a = t.length; i < a; i++) {
          ...
          else if (Array.isArray(u)) o = ee(e, u, s) || o;
          else if ("function" === a)
            if (r) {
              for (; "function" == typeof u; ) u = u();
              o =
                ee(e, Array.isArray(u) ? u : [u], Array.isArray(s) ? s : [s]) ||
                o;
            } else e.push(u), (o = !0);
          else {
            const t = String(u);
      ...
      Symbol();
      const re = "https://askme.amadeo.app/api",
        oe = n(330).rE || "unset";
      var ie = n(744);
      const ae = Symbol.for("Dexie"),
        ue = globalThis[ae] || (globalThis[ae] = ie);
      if (ie.semVer !== ue.semVer)
        throw new Error(
          `Two different versions of Dexie loaded in the same app: ${ie.semVer} and ${ue.semVer}`
        );
      const {
          liveQuery: se,
          mergeRanges: ce,
      ...
      const ge = new (class extends me {
        ...
        async saveMeetingState({ meetingState: e, tabId: t, hostUserName: n }) {
          ...
          return r && r.tabId
            ...
            : n
            ? this.meetingState.put({ hostUserId: xe(n), ...e, tabId: t })
            : (we("No user Id on save meeting state to DB", e),
      ...
      const _e = async (e, t) => {
        ...
        try {
          ...
          (r = t.join(", ")), we("Error on sendLog: ", e?.message);
        }
        const o = {
          method: "POST",
      ...
      function ke(e, t = !0) {
        ...
        if (
          (n || we(`Could not get localized message for variable "${e}"`), !t)
        )
          return n;
        return n.split(" ").map((e, n) => (t && n ? [" ", e] : e));
      }
      var Se = Y(
        '<div class=get-started-page-container><div class=logo><img alt=Ask_me><span>sk_me</span></div><div class=header><span></span><img src=../../assets/get_started_icon.png alt=""></div><div class=description><span></span></div><div class=action><span></span><a type=button href=https://meet.google.com/ rel="noopener noreferrer"> Google Meet</a></div><div class=steps><img src=../../assets/steps.webp alt=steps>'
      );
      const Ie = chrome.runtime.getURL("assets/logo.svg"),
        Pe = () => {
          return (
            (e = Se()),
            (t = e.firstChild),
            ...
            (i = r.nextSibling),
            (a = i.firstChild),
            (u = i.nextSibling.firstChild),
            (s = u.nextSibling),
            (c = s.firstChild),
            X(n, "src", Ie),
            Q(o, () => ke("getStartedTitleText", !1)),
            Q(a, () => ke("getStartedSubTitleText", !1)),
            Q(u, () => ke("getStartedLetTryText", !1)),
            Q(s, () => ke("openText", !1), c),
            e
          );
      ...
      var Oe = n(72),
        ...
        Ne = n(725),
        Fe = {};
      (Fe.styleTagTransform = qe()),
        (Fe.setAttributes = De()),
        (Fe.insert = Te().bind(null, "head")),
        (Fe.domAPI = Ce()),
        (Fe.insertStyleElement = Re());
      je()(Ne.A, Fe);
      Ne.A && Ne.A.locals && Ne.A.locals;
      J(() => H(Pe, {}), document.getElementsByTagName("body")[0]);
    })();
})();
